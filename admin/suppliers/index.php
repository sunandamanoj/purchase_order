...
<script>
    $(document).ready(function(){
        ...
        $('.delete_data').click(function(){
            _conf("Are you sure to delete this Costumer permanently?","delete_supplier",[$(this).attr('data-id')])
        });
        
        // Create new customer
        $('#create_new').click(function(){
            uni_modal("<i class='fa fa-plus'></i> New Costumer Register","suppliers/manage_supplier.php");
        });
        
        // View customer details
        $('.view_data').click(function(){
            uni_modal("<i class='fa fa-info-circle'></i> Costumer's Details","suppliers/view_details.php?id="+$(this).attr('data-id'),"");
        });
        
        // Edit customer details
        $('.edit_data').click(function(){
            uni_modal("<i class='fa fa-edit'></i> Edit Costumer's Details","suppliers/manage_supplier.php?id="+$(this).attr('data-id'));
        });
