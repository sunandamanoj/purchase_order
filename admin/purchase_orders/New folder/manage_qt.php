...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update Quotation Details": "New Quotation" ?> </h3>
	</div>
	<div class="card-body">
		<form action="" id="po-form">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							<label for="note" class="control-label">for Quotation Agreement Notes</label>
							<textarea name="note" id="note" cols="10" rows="4" class="form-control rounded-0"><?php echo isset($note) ? $note : '' ?></textarea>
						</div>
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<select name="status" id="status" class="form-control form-control-sm rounded-0">
								...
								<option value="2" <?php echo isset($status) && $status == 2 ? 'selected': '' ?>>Pending Quotation</option>
								<option value="2" <?php echo isset($status) && $status == 2 ? 'selected': '' ?>>Approved Quotation</option>
							</select>
						</div>
					</div>
				</div>
