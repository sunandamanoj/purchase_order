...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=purchase_orders/manage_po" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New Quotation</a>
			<a href="?page=purchase_orders/manage_po" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New Purchase Orders</a>
		</div>
	</div>
	<div class="card-body">
						...
						<tr>
								...
								<?php 
									switch ($row['status']) {
										case '1':
											...
											break;
										case '2':
											echo '<span class="badge badge-danger">Quotation</span>';
											break;
										default:
											echo '<span class="badge badge-secondary">Pending Orders</span>';
											break;
									}
								?>
								     </div>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
								  ...
								  <a class="dropdown-item" href="?page=purchase_orders/view_po&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View Quote</a>
								  <div class="dropdown-divider"></div>
								  	<a class="dropdown-item" href="?page=purchase_orders/view_poo&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View PO</a>
				                    <div class="dropdown-divider"></div>
