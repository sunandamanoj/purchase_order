...
<div class="card card-outline card-info">
                ...
                <b><br> 
						...
						<div class="col-md-6">
							...
							<select name="status" id="status" class="form-control form-control-sm rounded-0">
							    <option value="2" <?php echo isset($status) && $status == 2 ? 'selected': '' ?>>Purchase Orders</option>
								<option value="1" <?php echo isset($status) && $status == 1 ? 'selected': '' ?>>Pending Orders</option>
								<option value="0" <?php echo isset($status) && $status == 0 ? 'selected': '' ?>>Denied Orders</option>
								<option value="3" <?php echo isset($status) && $status == 3 ? 'selected': '' ?>>Quotation</option>
								<option value="4" <?php echo isset($status) && $status == 4 ? 'selected': '' ?>>Approved Quotation</option>
								<option value="5" <?php echo isset($status) && $status == 5 ? 'selected': '' ?>>Denied Quotation</option>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-primary" href="?page=purchase_orders/view_po_q&id=<?php echo $id ?>">View Purchase Orders</a>
		<a class="btn btn-flat btn-primary" href="?page=purchase_orders/view_poo_q&id=<?php echo $id ?>">View Quotation</a>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						location.href = "./?page=purchase_orders/manage_p_o_q_t&id="+resp.id;
