...
<div class="card card-outline card-info">
	<div class="card-header">
        ...
        <div class="card-tools">
		    ...
		    <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_orders/manage_quotation&id=<?php echo $id ?>">Edit</a>
	...
	<div class="card-body" id="out_print">
        ...
        <div class="col-6 d-flex align-items-center">
            <div>
            <center><img src="Quotation.PNG" alt="Flowers in Chania" width="1012" height="220">
                ...
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        ...
                        <tr class="po-item" data-id="">
                            ...
                            <td class="align-middle p-1 text-center total-price"><?php echo $row['unit'] ?></td>
                            <td class="align-middle p-1"><?php echo $row['name'] ?></td>
                            <td class="align-middle p-1 item-description"><?php echo $row['description'] ?></td>
                            <td class="align-middle p-1 text-right total-price"><?php echo number_format($row['unit_price'], 2) ?></td>
<td class="align-middle p-1 text-right total-price"><?php echo number_format($row['quantity'] * $row['unit_price'], 2) ?></td>
                    ...
                    <tfoot>
                        <tr class="bg-lightblue">
                            ...
                            <tr>
                                ...
                                <th class="p-1 text-right"><?php echo isset($discount_amount) ? number_format($discount_amount, 2) : '0.00' ?></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th class="p-1 text-right" id="total"><?php echo isset($tax_amount) ? number_format($sub_total - $discount_amount, 2) : '0.00' ?></th>
                            </tr>
                        </tr>
                    </tfoot>
                </table>
                <div class="row">
                    ...
                    <br>
                        ...
                        <label for="quotation_notes" class="control-label"></label>
                        <p><?php echo isset($quotation_notes) ? $quotation_notes : '' ?></p>
            ...
            <center><img src="signature.PNG" alt="Flowers in Chania" width="1012" height="220">
                    <div class="col-6">
