                ...
                <b><br> 
						...
						<div class="col-md-6">
							...
							<select name="status" id="status" class="form-control form-control-sm rounded-0">
								<option value="2" <?php echo isset($status) && $status == 2 ? 'selected': '' ?>>Quotation</option>
								<option value="1" <?php echo isset($status) && $status == 1 ? 'selected': '' ?>>Purchase Orders</option>
								<option value="0" <?php echo isset($status) && $status == 0 ? 'selected': '' ?>>Denied</option>
